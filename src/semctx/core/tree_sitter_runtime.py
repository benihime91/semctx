...
def _extract_js_ts(source: bytes, root: Node, *, include_ts_only: bool) -> list[dict[str, object]]:
  out: list[dict[str, object]] = []
...
@beartype
def extract_symbols_with_tree_sitter(file_path: Path, language: str) -> list[dict[str, object]]:
